...
function DepartmentCard(props: Props) {
  ...
  return (
    <div className="inline-block w-full max-w-sm min-h-full p-2 px-2 py-4 text-center text-gray-800 rounded-md hover:border-none">
      <div className="relative w-full group " style={{ transformStyle: 'preserve-3d' }}>
        ...
        <div className="relative bg-gray-800 text-center text-white  w-full h-full transition-all  duration-300 group opacity-100 group-hover:-translate-y-10 px-2 py-4 origin-[50%_100%] whitespace-normal">
